...
this._panelBox.append('<div class="page lookupBox"></div>');
...
var _lookup={currentGroup:"",suffix:false,$target:null};
var _util={
lookupPk:function(key){
return _lookup.currentGroup+"."+key+(_lookup.suffix?"[]":"");},
lookupField:function(key){
return "dwz."+_lookup.currentGroup+"."+key+(_lookup.suffix?"[]":"");}};
$.extend({
bringBackSuggest:function(args){
var $box=_lookup['$target'].parents(".lookupBox:first");
...
return '<tr class="lookupBox">'+html+'</tr>';}},
